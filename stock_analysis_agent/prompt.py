...
3. Ask the user for the stock ticker (hereafter refered to as provided_ticker) (e.g., "600519") they want to analyze and use google_search_agent to find the corresponding company name. If a company name is provided instead, use google_search_agent to find the corresponding ticker which should be a 6-digit string.
